...
import { GENESIS_MINT_WALLET_SEED_ONE, GENESIS_MINT_WALLET_SEED_THREE, GENESIS_MINT_WALLET_SEED_TWO } from './utils/constants.js';
...
const getWalletDetails = (wallet: WalletSelection): { seed: string, privateStateStoreName: string } => {
  switch (wallet) {
    case 'DEPLOY':
