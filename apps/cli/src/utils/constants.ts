...
const WALLET_FIVE_SEED_PHRASE = "kite cereal sunset anger unlock feed chat knee private note pen cup possible nest dad salad figure father volume fortune scale tell supply cargo";
export const MINT_WALLET_SEED_FIVE = Buffer.from(mnemonicToEntropy(WALLET_FIVE_SEED_PHRASE, wordlist)).toString('hex');
