...
export const SentinelContractConstructor = Contract<PrivateState, Witnesses<PrivateState>>;
export type SentinelContractType = InstanceType<typeof SentinelContractConstructor>;
